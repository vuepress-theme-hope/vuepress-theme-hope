 ...
 * @LastEditors: Mr.Hope
 * @LastEditTime: 2019-10-16 18:21:16
 * @Description: 侧边栏处理
 */
...
const resolveSideBar = (sidebarConfig, prefix = '') =>
  sidebarConfig.map(element => {
    ...
    if ((typeof element === 'object' || typeof element === 'function') && element.children) {
      if (Array.isArray(element.children) && (element.prefix || prefix)) {
