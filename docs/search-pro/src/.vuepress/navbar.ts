const navbar = [
  ...
  { text: "开发文档", link: "/dev-doc/index/", icon: "code" },
  {
    ...
    icon: "info",
    children: [
      { text: "文章", link: "/article/", icon: "blog" },
      { text: "分类", link: "/category/", icon: "type" },
...
const twNavbar = [
  ...
  { text: "开发文档繁中", link: "/zh-TW/dev-doc/index/", icon: "code" },
  {
    ...
    icon: "info",
    children: [
      { text: "文章繁中", link: "/zh-TW/article/", icon: "blog" },
      { text: "分类繁中", link: "/zh-TW/category/", icon: "type" },
      { text: "标签繁中", link: "/zh-TW/tag/", icon: "tag" },
      { text: "时间轴繁中", link: "/zh-TW/timeline/", icon: "time" },
    ],
  },
  {
    text: "浏览器下载繁中",
