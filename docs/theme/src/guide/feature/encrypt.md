...
The salted hash value of the number `1234` and the string `'1234'` is different! And the website can only enter the content in the string format through the input box.
