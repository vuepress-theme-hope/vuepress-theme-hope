...
[Twikoo official documentation](https://twikoo.js.org)
...
Follow the [official documentation](https://twikoo.js.org/backend.html) to deploy the backend, then set the backend URL in theme options:
...
Click the "little gear" icon in the comment window in time to open the Twikoo admin panel and set the administrator password.
