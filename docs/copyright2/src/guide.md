...
To avoid disturbing visitors, copyright information will be appended only when the length of content copied by the user is not less than `100`. If you want to change this threshold, please set `triggerWords`, and this option supports being overridden via `copy.triggerWords` in page frontmatter.
