...
export interface BlogPluginOptions
   ...
   *
   * @description This is an advanced option, please refer to the [blog plugin documentation](https://ecosysten.vuejs.press/plugins/blog/) for details
   *
   * 额外的文章类型
   *
   * @description 这是一个高级选项，请参考 [blog 插件文档](https://ecosysten.vuejs.press/zh/plugins/blog/) 了解详情
   *
   * @default []
   */
