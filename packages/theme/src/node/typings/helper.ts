...
export type ThemeBackToTopPluginHelper = Helper<BackToTopPluginOptions | boolean>;
...
export type ThemeCopyrightPluginHelper = Helper<CopyrightPluginOptions | boolean>;

export type ThemeFeedPluginHelper = Helper<Omit<FeedPluginOptions, "hostname"> | boolean>;
...
export type ThemePhotoSwipePluginHelper = Helper<PhotoSwipePluginOptions | boolean>;
...
export type ThemeReadingTimePluginHelper = Helper<ReadingTimePluginOptions | false>;

export type ThemeRedirectPluginHelper = Helper<RedirectPluginOptions | boolean>;

export type ThemeRevealPluginHelper = Helper<Omit<RevealJsPluginOptions, "layout"> | boolean>;

export type ThemeSEOPluginHelper = Helper<Omit<SeoPluginOptions, "hostname" | "author"> | boolean>;

export type ThemeShikiPluginHelper = Helper<ShikiPluginOptions | boolean>;

export type ThemeSitemapPluginHelper = Helper<Omit<SitemapPluginOptions, "hostname"> | boolean>;

export type ThemeWatermarkPluginHelper = Helper<WatermarkPluginOptions | boolean>;
