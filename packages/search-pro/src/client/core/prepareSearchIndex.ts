...
import type { Frontmatter, PageContent, PageIndex, VuepressPage, VuepressApp } from './types'
...
export async function prepareSearchIndex({ app }: { app: VuepressApp }): Promise<string> {
