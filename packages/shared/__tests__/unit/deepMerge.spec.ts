...
import { deepMerge } from "../../src/shared/utils/deepMerge.js";
...
describe("deep merge", () => {
  it("simple merge", () => {
    ...
    const ans1 = deepMerge(object1, object2);
    ...
    const ans2 = deepMerge(object3, object4);
  ...
  it("merge object", () => {
    ...
    const ans = deepMerge(object1, object2);
  ...
  it("merge multi object", () => {
    ...
    const ans = deepMerge<Record<string, any>>(object1, object2, object3);
